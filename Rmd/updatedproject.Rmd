...
4. JESSIE Is there a difference between migration time and amount of fish (per month, per location)? -> Normal linear regression
...
## Response variable is Forklength
## Predictor variable is Sex 
## Filter out unknown values in sex category of dataframe 
## First check to see if fl is normally distributed 
## Forklength appears to be normally distributed
